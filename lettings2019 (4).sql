...
) ENGINE=InnoDB AUTO_INCREMENT=335 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Tasks, Reminders, Notes';
...
(331, '2020-02-24 07:20:41', 1, 1),
(332, '2020-02-24 07:45:03', 1, 1),
(333, '2020-02-24 07:46:27', 1, 1),
(334, '2020-02-24 08:54:23', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `activity_assigned1`
--

DROP TABLE IF EXISTS `activity_assigned1`;
CREATE TABLE IF NOT EXISTS `activity_assigned1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `activity_assigned1`
--

INSERT INTO `activity_assigned1` (`id`, `activity_id`, `property_id`, `landlord_id`, `applicant_id`, `tenancy_id`, `contact_id`, `maintenance_id`) VALUES
(1, 173, 27, 7, 10, 25, 0, 0),
(2, 174, 36, 25, 32, 25, 0, 0),
(3, 329, 24, 0, 1, 0, 0, 2),
(4, 330, 24, 2, 32, 26, 0, 1),
(5, 331, 31, 6, 33, 26, 0, 0);
...
--
-- Table structure for table `activity_maintenance`
--

DROP TABLE IF EXISTS `activity_maintenance`;
...
--
-- Dumping data for table `activity_maintenance`
--

INSERT INTO `activity_maintenance` (`id`, `activity_id`, `maintenance_id`) VALUES
(1, 333, 8);
...
--
-- Table structure for table `activity_tenancy`
--

DROP TABLE IF EXISTS `activity_tenancy`;
CREATE TABLE IF NOT EXISTS `activity_tenancy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `activity_id` int(11) NOT NULL,
...
--
-- Dumping data for table `activity_tenancy`
--

INSERT INTO `activity_tenancy` (`id`, `activity_id`, `tenancy_id`) VALUES
(1, 67, 25),
(2, 329, 26),
(3, 333, 25),
(4, 334, 25);
...
(43, 67, 1, 2, 'rightmove', '2020-02-21 12:20:10'),
(44, 67, 1, 5, 'password', '2020-02-21 12:20:39'),
(45, 67, 1, 3, 'zoopla', '2020-02-21 12:20:39'),
(46, 67, 1, 5, 'password', '2020-02-21 12:54:31'),
(47, 67, 1, 4, 'zoopla', '2020-02-21 13:01:42'),
(48, 67, 1, 2, 'zoopla', '2020-02-21 13:01:47'),
(49, 67, 1, 5, 'password', '2020-02-21 13:01:58'),
(50, 67, 1, 5, 'password', '2020-02-21 13:04:03'),
(51, 67, 1, 2, 'gumtree', '2020-02-21 14:40:53'),
(52, 67, 1, 5, 'password', '2020-02-21 14:40:57'),
(53, 67, 1, 2, 'rightmove', '2020-02-21 14:52:20'),
(54, 67, 1, 5, 'password', '2020-02-21 14:53:09'),
(55, 67, 1, 3, 'gumtree', '2020-02-21 14:53:09'),
(56, 67, 1, 3, 'zoopla', '2020-02-21 14:53:09'),
(61, 67, 1, 4, 'rightmove', '2020-02-21 16:49:27'),
(62, 67, 1, 4, 'rightmove', '2020-02-21 16:50:04'),
(63, 67, 1, 2, 'zoopla', '2020-02-21 17:26:31'),
(64, 67, 1, 2, 'zoopla', '2020-02-21 17:28:55'),
(65, 67, 1, 2, 'zoopla', '2020-02-21 17:30:18');
...
(22, 'bijo', 'bijodesigndirectuk@gmail.com');
...
--
-- Table structure for table `document_email_users`
--

DROP TABLE IF EXISTS `document_email_users`;
CREATE TABLE IF NOT EXISTS `document_email_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `document_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `user_type_id` int(11) NOT NULL,
...
--
-- Dumping data for table `document_email_users`
--

INSERT INTO `document_email_users` (`id`, `document_id`, `user_id`, `user_type_id`, `field_id`, `url_key`, `status`, `sent_time`, `view_time`, `signed_time`) VALUES
(1, 4, 40, 4, 4, '7Q5Qbe40iOFF', 'Sent', '2020-02-28 15:49:33', NULL, NULL),
(2, 4, 67, 2, 5, 'KjQjjcj2G1f4', 'Sent', '2020-02-28 15:49:33', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `document_lettings`
--

DROP TABLE IF EXISTS `document_lettings`;
CREATE TABLE IF NOT EXISTS `document_lettings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `document_id` int(11) NOT NULL,
  `lettings_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  KEY `document_lettings_ibfk_2` (`lettings_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `document_offer` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  KEY `document_offer_ibfk_2` (`offer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(33, '7902', 1, '2020-02-19 18:30:00', '2020-02-28', 67, 1, 'Deposit for the property for sale -Breaks Road, Hatfield, AL10 8TR - singlehatfieldroom', '', 0, 1),
(34, '7903', 1, '2020-02-19 18:30:00', '2020-02-28', 67, 1, 'Deposit for the property for sale -Breaks Road, Hatfield, AL10 8TR - singlehatfieldroom', '', 0, 1),
(35, '7904', 1, '2020-02-19 18:30:00', '2020-02-27', 67, 1, 'Deposit for the property for sale -Breaks Road, Hatfield, AL10 8TR - singlehatfieldroom', '', 0, 1),
(36, '7905', 1, '2020-02-19 18:30:00', '2020-02-28', 67, 1, 'Deposit for the property for sale -Hendon Lane, London, N3 1TR - LOL09', '', 0, 1),
(37, '7906', 1, '2020-02-23 18:30:00', '2020-03-03', 69, 1, 'Deposit for the property for sale -007, 60, Holborn Viaduct, Holborn, London, EC1A 2FD - 001', '', 0, 1),
(38, '7907', 1, '2020-02-24 18:30:00', '2020-02-29', 3, 1, 'Deposit for the property for sale -Nevill Road, London, N16 8SR - LOL03', '', 0, 1),
(39, '7908', 1, '2020-02-24 18:30:00', '2020-02-27', 3, 1, 'Deposit for the property for sale -Nevill Road, London, N16 8SR - LOL03', '', 0, 1),
(40, '7909', 1, '2020-02-24 18:30:00', '2020-02-29', 3, 1, 'Deposit for the property for sale -Goldings Crescent, Hatfield, AL10 8UD - LOL02', '', 0, 1);
...
(4, 'Item 1', 20, 1, 100),
(4, 'item 3', 5, 10, 100),
(33, 'Deposit for the property for sale -Breaks Road, Hatfield, AL10 8TR - singlehatfieldroom', 5, 1, 50),
(34, 'Deposit for the property for sale -Breaks Road, Hatfield, AL10 8TR - singlehatfieldroom', 5, 1, 100),
(35, 'Deposit for the property for sale -Breaks Road, Hatfield, AL10 8TR - singlehatfieldroom', 0, 1, 10),
(36, 'Deposit for the property for sale -Hendon Lane, London, N3 1TR - LOL09', 0, 1, 100),
(37, 'Deposit for the property for sale -007, 60, Holborn Viaduct, Holborn, London, EC1A 2FD - 001', 0, 1, 10000),
(38, 'Deposit for the property for sale -Nevill Road, London, N16 8SR - LOL03', 0, 1, 100),
(39, 'Deposit for the property for sale -Nevill Road, London, N16 8SR - LOL03', 0, 1, 100),
(40, 'Deposit for the property for sale -Goldings Crescent, Hatfield, AL10 8UD - LOL02', 0, 1, 50);
...
(31, 33, 1, 52, '2020-02-20 10:13:05', '2020-02-19', '', 1, 13),
(32, 37, 1, 10000, '2020-02-24 10:25:55', '2020-02-24', '', 1, 14),
(33, 40, 1, 50, '2020-02-25 06:53:13', '2020-02-25', '', 1, 15);
...
INSERT INTO `lettings_agreement_templates` (`id`, `template_type_id`, `title`, `content`, `opt_type`) VALUES
(1, 18, 'Tenancy Agreement', , 2),
(2, 0, 'Test Temp', 0x3c703e7b7478745f746573745f757365725f747970655f6e616d655f6f665f757365727d7b7379735f6170706c6963616e745f6e616d655f685f6e6f7d3c2f703e, 1);
...
(4, 'Tenancy Agreement', , 1, 1, 'Sent', '2020-02-28 15:49:33', '0000-00-00');
...
--
-- Dumping data for table `offer_price_history`
--

INSERT INTO `offer_price_history` (`id`, `offer_id`, `new_price`, `old_price`, `reason`, `changed_date`, `manager_id`) VALUES
(5, 3, 1120, 1100, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#039;s standard dummy text ever since the 1500s, ', '2020-02-20 17:33:49', 1),
(6, 5, 680000, 6800000, 'price test change', '2020-02-24 15:54:16', 1);
...
--
-- Dumping data for table `offer_reject_reasons`
--

INSERT INTO `offer_reject_reasons` (`id`, `offer_id`, `status_id`, `reason`, `manager_id`) VALUES
(2, 3, 7, 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,', 1),
(3, 5, 6, 'test', 1),
(4, 6, 6, 'test reason', 1),
(5, 7, 6, 'ghffj', 1);
...
CREATE TABLE IF NOT EXISTS `offer_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET latin1 NOT NULL,
  `status_label` varchar(255) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(42, 1, 1, 1, 5, 4, 21, '3 bedroom flat for sale', '001', '3-bedroom-flat-for-sale', '', '', '', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#039;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum', 'AVAILABLE TODAY\r\nClose to all amenities and transport.\r\nCarpets throughout\r\nDouble Glazing\r\nNeutral decor\r\nFully fitted kitchen with all appliances\r\nBRIGHT and AIRY\r\nGas Central Heating\r\n3 piece bathroom with SHOWER attachment\r\nProfessional couple, sharers or family - NO PETS', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#039;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum', '007', '60, Holborn Viaduct, Holborn', 'London', 'EC1A 2FD', 220, '2020-02-20', '51.5173115', '-0.1044438', 795000, '2020-02-21 12:11:38', 0, 1, 2);
...
(3, 32, 67, 1120, 5, 1, 0, 'Test', 'Test test', 'test condition', 1),
(5, 42, 69, 680000, 6, 1, 10000, 'test', '', '', 1),
(6, 26, 3, 1200, 5, 1, 100, 'test', '', '', 1),
(7, 25, 3, 620, 2, 1, 50, 'test', '', '', 1);
...
INSERT INTO `property_offer_dates` (`id`, `offer_id`, `created_date`, `accepted_date`, `refused_date`, `cancelled_date`, `completion_date`) VALUES
(3, 3, '2020-02-20', '2020-02-20', NULL, '2020-02-20', '2020-02-20'),
(5, 5, '2020-02-24', '2020-02-24', '2020-02-24', NULL, '2020-02-24'),
(6, 6, '2020-02-25', '2020-02-25', '2020-02-25', NULL, '2020-02-25'),
(7, 7, '2020-02-25', '2020-02-25', '2020-02-25', NULL, NULL);
...
INSERT INTO `rightmove_api_files` (`id`, `settings_id`, `manager_id`, `filename`, `path`) VALUES
(16, 0, 1, 'lettingsoflondontest.jks', 'E:/wamp64/www/lettingsoflondon/resources/storage/rightmove_data/1'),
(17, 0, 1, 'lettingsoflondontest.p12', 'E:/wamp64/www/lettingsoflondon/resources/storage/rightmove_data/1'),
(18, 0, 1, 'lettingsoflondontest.pem', 'E:/wamp64/www/lettingsoflondon/resources/storage/rightmove_data/1');
...
INSERT INTO `rightmove_api_settings` (`id`, `manager_id`, `network_id`, `branchID`, `cert_file_name`, `key_password`, `is_test`) VALUES
(1, 1, '2313', 'fsdfsd', 'sdfsdf', 'fsdfds', 1),
(2, 1, '00000', '0000000', 'test.pem', '99999999', 0);
...
(13, 325, 49, 'Property test', 'rgb(150, 254, 127)', '', '1289px', '364px', 120, 286, '', '2020-02-20');

-- --------------------------------------------------------

--
-- Table structure for table `system_fields_to_document`
--

DROP TABLE IF EXISTS `system_fields_to_document`;
CREATE TABLE IF NOT EXISTS `system_fields_to_document` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `document_id` int(11) NOT NULL,
  `field_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `system_fields_to_document`
--

INSERT INTO `system_fields_to_document` (`id`, `document_id`, `field_id`) VALUES
(1, 4, 8),
(2, 4, 3),
(3, 4, 5),
(4, 4, 4);
...
--
-- Table structure for table `system_fields_to_template`
--

DROP TABLE IF EXISTS `system_fields_to_template`;
CREATE TABLE IF NOT EXISTS `system_fields_to_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `template_id` int(11) NOT NULL,
  `field_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `system_fields_to_template`
--

INSERT INTO `system_fields_to_template` (`id`, `template_id`, `field_id`) VALUES
(5, 2, 2),
(6, 1, 8),
(7, 1, 3),
(8, 1, 5),
...
--
-- Table structure for table `system_types_to_user_type`
--

DROP TABLE IF EXISTS `system_types_to_user_type`;
CREATE TABLE IF NOT EXISTS `system_types_to_user_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `system_types_to_user_type`
--

INSERT INTO `system_types_to_user_type` (`id`, `field_type_id`, `user_type_id`) VALUES
(1, 1, 5),
(2, 3, 6),
(3, 6, 2),
(4, 7, 4),
...
(11, 75, 5, 'Property Inspection for 2 bedroom maisonette to rent', 'Property Inspection for the property 2 bedroom maisonette to rent. Requested by the client', '2020-02-29 16:15:00', 2, 0, 0),
...
(47, 329, 2, 'maintenance test', 'maintenance test', '2020-03-06 18:15:00', 1, 0, 0),
(48, 330, 10, 'Plumbing event test', 'Plumbing event test', '2020-02-12 13:00:00', 1, 0, 0),
(49, 331, 1, 'Test Call task for 27th', 'test', '2020-02-27 12:45:00', 1, 0, 0),
(50, 332, 10, 'test roofing', '', '2020-02-24 13:00:00', 1, 0, 0),
(51, 333, 10, 'test estest sedtes set', '', '2020-02-26 13:15:00', 1, 0, 0),
(52, 334, 10, '123 test', '', '2020-02-26 14:15:00', 1, 0, 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Staffs to which the task is assigned';
...
(2, 1, 'name of user', 1, '{txt_test_user_type_name_of_user}', 2),
(3, 2, 'Enter the name of tenant', 1, '{txt_tenant_enter_the_name_of_tenant}', 1);
...
INSERT INTO `template_options` (`id`, `title`) VALUES
(1, 'Normal'),
(2, 'Default');
...
--
-- Table structure for table `template_system_data_fields`
--

DROP TABLE IF EXISTS `template_system_data_fields`;
CREATE TABLE IF NOT EXISTS `template_system_data_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type_id` int(11) NOT NULL,
  `field_label` varchar(255) COLLATE utf8_bin NOT NULL,
  `replace_text` varchar(255) COLLATE utf8_bin NOT NULL,
  `table_fields` varchar(255) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `template_system_data_fields`
--

INSERT INTO `template_system_data_fields` (`id`, `type_id`, `field_label`, `replace_text`, `table_fields`, `table_name`, `data_type`) VALUES
(1, 1, 'Applicant Full Name', '{sys_applicant_name_lname}', 'name,lname', 'user_clients', 1),
(2, 1, 'Applicant House Name / Number', '{sys_applicant_name_h_no}', 'h_no', 'user_clients', 1),
(3, 7, 'Tenant Full Name', '{sys_tenant_fullname}', 'name,lname', 'user_clients', 1),
(4, 7, 'Tenant Signatue', '{sys_tenant_signature}', 'sign', '', 3),
(5, 6, 'Landlord eSignature', '{sys_landlord_signature}', 'sign', '', 3),
(6, 1, 'Applicant eSignature', '{sys_applicant_signature}', 'sign', '', 3),
(7, 7, 'Tenant Address', '{sys_tenant_address}', '', 'user_clients', 1),
(8, 6, 'Landlord Full Name', '{sys_landlord_full_name}', 'name,lname', 'user_clients', 1),
(9, 3, 'Client Signature', '{sys_client_signature}', 'sign', '', 3);

-- --------------------------------------------------------

--
-- Table structure for table `template_system_types`
--

DROP TABLE IF EXISTS `template_system_types`;
CREATE TABLE IF NOT EXISTS `template_system_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `template_system_types`
--

INSERT INTO `template_system_types` (`id`, `title`) VALUES
(1, 'Applicant'),
(2, 'Property'),
(3, 'Contact'),
(4, 'Offer'),
...
INSERT INTO `template_types` (`id`, `title`) VALUES
(1, 'All Types'),
(2, 'Applicants'),
(3, 'Applicant Finance'),
(4, 'Contacts'),
...
(4, 3, 1, '', 'Ajay', 'Kumar', '98765432123', '', 'Nevill Road', 'London', 'N16 8SR', '3432532'),
...
(68, 67, 1, 'Hashwide', 'Akhil', 'V V', '5435435435', '', 'Hendon Lane', 'London', 'N3 1TR', ''),
(69, 68, 1, '', 'Anand', 'test', '987', '', '', '', '', ''),
(70, 69, 1, '', 'Akhil', 'karun', '9876543210', '007', '60, Holborn Viaduct, Holborn', 'London', 'EC1A 2FD', ''),
...
--
-- Dumping data for table `zoopla_api_settings`
--

INSERT INTO `zoopla_api_settings` (`id`, `manager_id`, `branchID`, `cert_file_name`, `certKey`, `is_test`) VALUES
(1, 1, '121', '232', 'gsdgds', 0),
(2, 1, 'fsdfsdf', 'sdfsd', 'dsfsdf', 1);
...
--
-- Constraints for table `activity_assigned1`
--
ALTER TABLE `activity_assigned1`
  ADD CONSTRAINT `activity_assigned1_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `activity_assigned1_ibfk_2` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `activity_assigned1_ibfk_3` FOREIGN KEY (`applicant_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `document_email_users`
--
ALTER TABLE `document_email_users`
  ADD CONSTRAINT `document_email_users_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `letting_documents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `document_email_users_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `document_email_users_ibfk_3` FOREIGN KEY (`user_type_id`) REFERENCES `user_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `document_email_users_ibfk_4` FOREIGN KEY (`field_id`) REFERENCES `template_system_data_fields` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `document_lettings`
--
ALTER TABLE `document_lettings`
  ADD CONSTRAINT `document_lettings_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `letting_documents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `document_lettings_ibfk_2` FOREIGN KEY (`lettings_id`) REFERENCES `property_lettings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `document_offer`
--
ALTER TABLE `document_offer`
  ADD CONSTRAINT `document_offer_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `letting_documents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `document_offer_ibfk_2` FOREIGN KEY (`offer_id`) REFERENCES `property_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `invoice_offer`
--
ALTER TABLE `invoice_offer`
  ADD CONSTRAINT `invoice_offer_ibfk_1` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `invoice_offer_ibfk_2` FOREIGN KEY (`offer_id`) REFERENCES `property_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `offer_price_history`
--
ALTER TABLE `offer_price_history`
  ADD CONSTRAINT `offer_price_history_ibfk_1` FOREIGN KEY (`offer_id`) REFERENCES `property_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `offer_price_history_ibfk_2` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `offer_reject_reasons`
--
ALTER TABLE `offer_reject_reasons`
  ADD CONSTRAINT `offer_reject_reasons_ibfk_1` FOREIGN KEY (`offer_id`) REFERENCES `property_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `offer_reject_reasons_ibfk_2` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `property_offers`
--
ALTER TABLE `property_offers`
  ADD CONSTRAINT `property_offers_ibfk_1` FOREIGN KEY (`applicant_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `property_offers_ibfk_2` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `property_offers_ibfk_3` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `property_offers_ibfk_4` FOREIGN KEY (`status`) REFERENCES `offer_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `property_offers_ibfk_5` FOREIGN KEY (`progress_status`) REFERENCES `offer_progress_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `property_offer_dates`
--
ALTER TABLE `property_offer_dates`
  ADD CONSTRAINT `property_offer_dates_ibfk_1` FOREIGN KEY (`offer_id`) REFERENCES `property_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `system_fields_to_document`
--
ALTER TABLE `system_fields_to_document`
  ADD CONSTRAINT `system_fields_to_document_ibfk_1` FOREIGN KEY (`field_id`) REFERENCES `template_system_data_fields` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `system_fields_to_document_ibfk_2` FOREIGN KEY (`document_id`) REFERENCES `letting_documents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `system_fields_to_template`
--
ALTER TABLE `system_fields_to_template`
  ADD CONSTRAINT `system_fields_to_template_ibfk_1` FOREIGN KEY (`field_id`) REFERENCES `template_system_data_fields` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `system_fields_to_template_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `lettings_agreement_templates` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `system_types_to_user_type`
--
ALTER TABLE `system_types_to_user_type`
  ADD CONSTRAINT `system_types_to_user_type_ibfk_1` FOREIGN KEY (`field_type_id`) REFERENCES `template_system_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `system_types_to_user_type_ibfk_2` FOREIGN KEY (`user_type_id`) REFERENCES `user_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `template_system_data_fields`
--
ALTER TABLE `template_system_data_fields`
  ADD CONSTRAINT `template_system_data_fields_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `template_system_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `template_system_data_fields_ibfk_2` FOREIGN KEY (`data_type`) REFERENCES `template_fields_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
